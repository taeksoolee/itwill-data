...
<%-- => [회원가입] 버튼을 클릭한 경우 회원가입 처리페이지(member_join_action.jsp)를 요청하여 입력값 전달  --%>
...
<form id="join" name="joinForm" action="<%=request.getContextPath() %>/site/index.jsp?workgroup=member&work=member_join_action" method="post">
...
$("#idCheck").click(function() {
	...
	window.open("<%=request.getContextPath()%>/site/member/id_check.jsp?id="
		+$("#id").val(),"idcheck","width=400,height=100,left=450,top=250");
});
