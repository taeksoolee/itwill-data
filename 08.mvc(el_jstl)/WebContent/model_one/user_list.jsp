...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- USERINFO 테이블에 저장된 모든 회원정보를 검색하여 클라이언트에게 
전달하는 JSP 문서 - 로그인 상태의 사용자만 접근 가능 --%>
<%-- => [회원이름]을 클릭한 경우 회원정보 상세 출력페이지(user_view.jsp) 요청 --%>
...
<%
	...
	List<UserinfoDTO> userinfoList=UserinfoModelOneDAO.getDAO().selectAllUserinfo();
%>
